...
public final class RegularBundle implements Serializable,
	...
	public RegularBundle() {
		this(new MacAddress("ff-ff-ff-ff-ff-ff"), new SSID("Example"),
				new Location(0.0, 0.0), new Date(), ConnectionCode.UNKNOWN);
	}

	public RegularBundle(MacAddress clientMac, SSID clientSSID,
			Location clientLocation, Date clientTime,
